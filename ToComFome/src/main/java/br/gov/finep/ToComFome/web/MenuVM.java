...
public class MenuVM implements Serializable {
    ...
    public static final String NOME_APLICACAO = "ToComFome";
    ...
    public static String urlTelaRestaurante() {
        return getUrlAplicacao() + URL_INTRANET + "/privado/telaRestaurante.zul";
    }
    ...
    public void personificar() {
        ...
        try {
            if (!LoginUtil.isLoginDeUsuarioExterno(loginPersonificado)) {
                ...
                Executions.sendRedirect(UsuarioUtil.personificar(request, response, loginPersonificado, getUrlAplicacao() + URL_EXTERNO));
            }
        } catch (Exception e) {
